...
class SpEagle():
    ...
    def __init__(self, user_product_graph, priors, potentials, message = None, max_iters=1):
        ...
        self._product_priors = priors[1]
        self._review_priors = priors[2]
    ...
    def add_new_data(self, new_user_product_graph, new_priors):
        ...
        new_p_priors = new_priors[1]
        new_r_priors = new_priors[2]
...
if __name__ == '__main__':
    ...
    model.schedule()
    model.run_bp()
    _, predictions, _ = model.classify()
